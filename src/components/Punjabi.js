...
export default class Punjabi extends React.Component {
    ...
    componentDidMount() {
        axios({
            method: 'get',
            url: "https://www.googleapis.com/youtube/v3/search?part=snippet&relatedToVideoId=Kd57YHWqrsI&maxResults=25&type=video&key=AIzaSyCYnz2BIh3II4v9LlDizrr6F2aj7LVCAU0"
        })
    ...
    render() {
        return (
            <div>
                <h1 className="display-4 text-center text-success">Punjabi Dance Beats</h1>
