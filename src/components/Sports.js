...
export default class Science extends React.Component {
    ...
    componentDidMount() {
        axios({
            method: 'get',
           url: "https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&maxResults=27&chart=mostPopular&regionCode=in&videoCategoryId=17&key=AIzaSyCYnz2BIh3II4v9LlDizrr6F2aj7LVCAU0"
        })
            .then((response) => {
