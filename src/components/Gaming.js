...
export default class Gaming extends React.Component {
    ...
    componentDidMount() {
        axios({
            method: 'get',
            url: "https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=27&regionCode=in&videoCategoryId=20&key=AIzaSyCYnz2BIh3II4v9LlDizrr6F2aj7LVCAU0"
        })
            .then((response) => {
        ...
        return (
            <div>
                ...
                <div style={{ marginTop: "100px" }}>
                    <h1 className="display-3 text-info text-center"style={{fontFamily:'Roboto Mono'}}>Trending Gaming Videos</h1>
