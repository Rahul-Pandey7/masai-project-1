...
export default class Religious extends React.Component {
    ...
    componentDidMount() {
        axios({
            method: 'get',
            url: "https://www.googleapis.com/youtube/v3/search?part=snippet&relatedToVideoId=Y8e8qcbWzJY&maxResults=27&type=video&key=AIzaSyCYnz2BIh3II4v9LlDizrr6F2aj7LVCAU0"
        })
