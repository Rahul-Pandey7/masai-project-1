...
export default class Subscription extends React.Component {
    ...
    componentDidMount() {
        axios({
            method: 'get',
            url: "GET https://www.googleapis.com/youtube/v3/subscriptions?part=snippet%2CcontentDetails&mine=true&key=AIzaSyCYnz2BIh3II4v9LlDizrr6F2aj7LVCAU0"
        })
    ...
    render() {
        return (
            <div>
                <h1 className="display-4 text-center text-success">Subscription list</h1>
